...
/>
          ...
          <button 
            className="bg-white text-sky-500 rounded-md px-5 py-2 text-sm font-medium hover:bg-[#2C2E74] hover:text-white transition duration-300 ease-out w-full">Subscribe</button>
        </div>
      </div>
