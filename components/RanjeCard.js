...
const ranges = [
  ...
  { src: tips, title: "What to buy", description: "Practical advice, support, and resources to manage incontinence.", link: "/healtTips" },
    ...
    <div className="relative w-full">
      ...
      <div ref={scrollRef} className="flex space-x-6 overflow-x-auto md:pl-5 scrollbar-hide py-4 px-4 scroll-smooth">
        {ranges.map((range, index) => (
          <Link key={index} href={range.link} className="cursor-pointer flex-shrink-0 w-[300px]">
