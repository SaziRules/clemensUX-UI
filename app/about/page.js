...
export default function About() {
  ...
  <div className="flex-1 p-10 md:pr-10 w-full bg-gradient-to-r from-sky-500 to-indigo-500 md:w-1/2">
  ...
  <div className="flex-1 p-10 md:pl-10 w-full bg-gradient-to-r from-indigo-500 to-sky-500 md:w-1/2">
