...
const Subscriber = () => {
  ...
  const handleSubscribe = async (e) => {
    ...
    try {
      await addDoc(collection(db, "subscribers"), { name, email, timestamp: new Date() });
  ...
  return (
    <div className="flex flex-col lg:flex-row h-auto lg:h-[360px] lg:gap-0">
      ...
      <div className="flex-1 content-center p-5 bg-gradient-to-l from-sky-500 to-indigo-500 mx-[-2rem] sm:mx-[-2rem] lg:mx-0">
        ...
        <form onSubmit={handleSubscribe} className="text-center w-full max-w-[500px] space-y-2 items-center mx-auto justify-center pb-7 px-4 sm:px-0">
